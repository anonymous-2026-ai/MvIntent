...
class Model(nn.Module):
	...
	def forward(self, list_chunks_idx , list_triple_indexes ,  tokenizer):
		...
		# _ = [] 
		# for i in range(len(list_overall_triple)):
		# 	_.append(torch.matmul(list_overall_triple[i] , list_intent_hid[i].T))
		# # list_intent_weight  = torch.stack(list_intent_weight , dim= 0 )
		# intent_weight = torch.stack(_ , dim = 0)
		# print(list_triple_weight)
